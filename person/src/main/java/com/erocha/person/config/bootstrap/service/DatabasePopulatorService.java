        ...
        personRepository.saveAll(Lists.newArrayList(
                Person.builder()
                        ...
                        .address(Address.builder()
                                ...
                                .province("SP")
                                .build())
                        .contact(Contact.builder().type(ContactType.PHONE).value("19999722793").build())
                        .contact(Contact.builder().type(ContactType.WHATSAPP).value("19999722793").build())
                        .contact(Contact.builder().type(ContactType.EMAIL).value("erocha@jmail.com.br").build())
                        .build(),
                Person.builder()
                ...
                Person.builder()
                        ...
                        .contact(Contact.builder().type(ContactType.EMAIL).value("dvadder@jmail.com.br").build())
                        .address(Address.builder()
                ...
                Person.builder()
                        ...
                        .contact(Contact.builder().type(ContactType.EMAIL).value("jbond@jmail.com.br").build())
                        .address(Address.builder()
                ...
                Person.builder()
                        ...
                        .contact(Contact.builder().type(ContactType.EMAIL).value("carlos.melo_@bucaneiro.com.br").build())
                        .address(Address.builder()
                ...
                Person.builder()
                        ...
                        .contact(Contact.builder().type(ContactType.EMAIL).value("fneves@jmmarcenaria.com.br").build())
                        .address(Address.builder()
                ...
                Person.builder()
                        ...
                        .contact(Contact.builder().type(ContactType.EMAIL).value("bento.campos@weatherford.com").build())
                        .address(Address.builder()
                ...
                Person.builder()
                        ...
                        .contact(Contact.builder().type(ContactType.EMAIL).value("daviluccaduarte_@cvc.com.br").build())
                        .address(Address.builder()
                                .street("Rua Pádua")
                ...
                Person.builder()
                        ...
                        .contact(Contact.builder().type(ContactType.EMAIL).value("leandrorauledsonpeixoto_@diebold.com").build())
                        .address(Address.builder()
                ...
                Person.builder()
                        ...
                        .contact(Contact.builder().type(ContactType.EMAIL).value("hugo.rosa@arcante.com.br").build())
                        .address(Address.builder()
